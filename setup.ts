...
// const config = JSON.parse(fs.readFileSync('./zklmes.config.json').toString())
...
// program
//     .command('deploy')
//     .argument('<network>', 'name of the network in zklmes.config.json to deploy')
//     .action(async (network) => {
//         if(!config.networks[network]){
//             console.error(`ERROR: ${network} not found in zklmes.config.json`);
//             return;
//         }
...
//             console.error(`ERROR: ${src} not found in zklmes.config.json`);
//             return;
//         }
//         if(!config.networks[target]){
//             console.error(`ERROR: ${target} not found in zklmes.config.json`);
//             return;
//         }
